...
ACT_PON <-
  ...
  labs(x= "Pond", y= "Nightly Bat Activity")+
  scale_fill_manual(values = c("blue", "darkorange",  "darkorchid", "red", "darkgreen", "deeppink",  "bisque2"))+
...
RICH_PON <-
  ...
  geom_boxplot(color = "black")+
  geom_jitter(width = 0.1)+
  labs(x= "Pond", y= "Nightly Bat Richness")+
  scale_fill_manual(values = c("blue", "darkorange",  "darkorchid", "red", "darkgreen", "deeppink",  "bisque2"))+
  stat_summary(fun.y = mean, shape = 1, color = "brown")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black"))+
...
EPTFUS_ACT <-
  ...
  geom_boxplot(color = "black")+
  geom_jitter(width = 0.1)+
  labs(x= "Pond", y= "Nightly Big Brown Bat Activity")+
  scale_fill_manual(values = c("blue", "darkorange",  "darkorchid", "red", "darkgreen", "deeppink",  "bisque2"))+
  stat_summary(fun.y = mean, shape = 1, color = "brown")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black"))+
...
LASBOR_ACT <-
  ...
  geom_boxplot(color = "black")+
  geom_jitter(width = 0.1)+
  labs(x= "Pond", y= "Nightly Eastern Red Bat Activity")+
  scale_fill_manual(values = c("blue", "darkorange",  "darkorchid", "red", "darkgreen", "deeppink",  "bisque2"))+
  stat_summary(fun.y = mean, shape = 1, color = "brown")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black"))+
...
LASCIN_ACT <-
  ...
  geom_boxplot(color = "black")+
  geom_jitter(width = 0.1)+
  labs(x= "Pond", y= "Nightly Hoary Bat Activity")+
  scale_fill_manual(values = c("blue", "darkorange",  "darkorchid", "red", "darkgreen", "deeppink",  "bisque2"))+
  stat_summary(fun.y = mean, shape = 1, color = "brown")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black"))+
...
LASNOC_ACT <-
  ...
  geom_boxplot(color = "black")+
  geom_jitter(width = 0.1)+
  labs(x= "Pond", y= "Nightly Silver-Haired Bat Activity")+
  scale_fill_manual(values = c("blue", "darkorange",  "darkorchid", "red", "darkgreen", "deeppink",  "bisque2"))+
  stat_summary(fun.y = mean, shape = 1, color = "brown")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black"))+
...
MYOLUC_ACT <-
  ...
  geom_boxplot(color = "black")+
  geom_jitter(width = 0.1)+
  labs(x= "Pond", y= "Nightly Little Brown Bat Activity")+
  scale_fill_manual(values = c("blue", "darkorange",  "darkorchid", "red", "darkgreen", "deeppink",  "bisque2"))+
  stat_summary(fun.y = mean, shape = 1, color = "brown")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
  panel.background = element_blank(), axis.line = element_line(colour = "black"))+
