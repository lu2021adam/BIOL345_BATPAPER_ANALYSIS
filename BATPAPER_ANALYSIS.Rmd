...
BUBOLZ_DATA <- read_csv("~/Desktop/Wildlife_Ecology/Bat_Paper/BIOL345_BATPAPER_ANALYSIS/BUBOLZ_ID_SUMMARY.csv")

HECKRODT_DATA <- read_csv("~/Desktop/Wildlife_Ecology/Bat_Paper/BIOL345_BATPAPER_ANALYSIS/HECKRODT_ID_SUMMARY.csv")
...
```{r}
# Summary Data Sets to calculate species activity and richness at each pond are created here.This information will be used in the complete data set.
